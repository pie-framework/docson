...
docson.doc = function (element, schema, ref, baseUrl) {
    ...
    ready.then(function () {
        ...
        renderBox = function () {
            ...
            if (ref) {
                ref = ref[0] !== '/' ? '/' + ref : ref;
                target = _jsonpointer2.default.get(schema, ref);
                stack.push(schema);
            }
            target.root = true;
            target.__ref = "<root>";
            ...
            element.find(".box-title").each(function () {
                var ref = (0, _jquery2.default)(this).attr("ref");
                if (ref) {
                    if (window.location.href.indexOf("docson/index.html") > -1) {
                        (0, _jquery2.default)(this).find(".box-name").css("cursor", "pointer").attr("title", "Open in new window").hover(function () {
                            (0, _jquery2.default)(this).addClass('link');
                        }, function () {
                            (0, _jquery2.default)(this).removeClass('link');
                        }).click(function () {
            ...
            element.find(".box").mouseenter(function () {
                (0, _jquery2.default)(this).children(".source-button").fadeIn(300);
                (0, _jquery2.default)(this).children(".box-body").children(".expand-button").fadeIn(300);
            });
            element.find(".box").mouseleave(function () {
                (0, _jquery2.default)(this).children(".source-button").fadeOut(300);
                (0, _jquery2.default)(this).children(".box-body").children(".expand-button").fadeOut(300);
            });
            element.find(".signature-type-expandable").click(function () {
                var boxId = (0, _jquery2.default)(this).attr("boxid");
                (0, _jquery2.default)(this).toggleClass("signature-type-expanded");
                (0, _jquery2.default)(this).parent().parent().parent().children(".signature-box-container").children("[boxid='" + boxId + "']").toggle(resizeHandler ? 0 : 300);
                resized();
            });
            element.find(".expand-button").click(function () {
                if ((0, _jquery2.default)(this).attr("expanded")) {
                    (0, _jquery2.default)(this).parent().parent().find(".expand-button").html(" + ").attr("title", "Expand all");
                    (0, _jquery2.default)(this).parent().parent().find(".signature-type-expandable").removeClass("signature-type-expanded");
                    (0, _jquery2.default)(this).parent().parent().find(".box-container").hide(resizeHandler ? 0 : 300);
                    (0, _jquery2.default)(this).parent().parent().find(".expand-button").removeAttr("expanded");
                    resized();
                } else {
                    (0, _jquery2.default)(this).parent().parent().find(".expand-button").html(" - ").attr("title", "Collapse all");
                    (0, _jquery2.default)(this).parent().parent().find(".signature-type-expandable").addClass("signature-type-expanded");
                    (0, _jquery2.default)(this).parent().parent().find(".box-container").show(resizeHandler ? 0 : 300);
                    (0, _jquery2.default)(this).parent().parent().find(".expand-button").attr("expanded", true);
                    resized();
                }
            });
            element.find(".source-button").click(function () {
                (0, _jquery2.default)(this).parent().children(".box-body").toggle();
                (0, _jquery2.default)(this).parent().children(".source").toggle();
                resized();
            });
        };
        ...
        var resolveSchemaRef = function (parentObject, item, baseUrl) {
            ...
            return new Promise((resolve, reject) => {
                ...
                if (typeof baseUrl === 'string') {
                    baseUrl = new _urijs2.default(baseUrl);
                }

                var uri = new _urijs2.default(item);
